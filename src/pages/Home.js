        ...
        <div class="container-fluid">
            <div class="row">
                <div class="pogoSlider" id="js-main-slider">
                    <div class="pogoSlider-slide" style={{backgroundImage: 'url("assets/images/x.jpg")'}}
>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="pogoSlider-slide" style={{backgroundImage: 'url("assets/images/banner_img.jpg")'}} >
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
	   ...
	   <div class="container">
	      <div class="row">
		      <div class="col-md-12">
			     <div class="tab_menu">
				    <ul>
					   <li><a href="#"><span class="icon"><img src="assets/images/i1.png" alt="#" /></span><span>University Life</span></a></li>
					   <li><a href="#"><span class="icon"><img src="assets/images/i2.png" alt="#" /></span><span>Graduation</span></a></li>
					   <li><a href="#"><span class="icon"><img src="assets/images/i3.png" alt="#" /></span><span>Athletics</span></a></li>
					   <li><a href="#"><span class="icon"><img src="assets/images/i4.png" alt="#" /></span><span>Social</span></a></li>
					   <li><a href="#"><span class="icon"><img src="assets/images/i5.png" alt="#" /></span><span>Location</span></a></li>
            ...
            <div class="row">
				...
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                       <img class="img-responsive" src="assets/images/p1.png" alt="#" /> 
					   <h4>Financial Accounting</h4>
                    </div>
                </div>
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="assets/images/p2.png" alt="#" />
						<h4>Managerial Accounting</h4>
                    </div>
                </div>
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="assets/images/p3.png" alt="#" />
